...
module immediate_extender (
    ...
    always_comb begin : extend_block
        case (imm_sel_i)
            ...
            IMM_B: imm_o = {{19{instr_i[31]}}, instr_i[31], instr_i[7], instr_i[31:25], instr_i[11:8], 1'b0};

            IMM_U: imm_o = {instr_i[31:12], 12'b0};

            IMM_J: imm_o = {{11{instr_i[31]}}, instr_i[31], instr_i[19:12], instr_i[20], instr_i[31:21], 1'b0};
